...
import {
    carrierAsync,
    carrierSelector,
} from '../../../../store/slices/Carrier/carrierSlice'
                                ...
                                <Box>
                                    ...
                                    {errors.maxcapacity && (
                                        <Alert
                                            ...
                                            className='mt-2'
                                        >
                                            {errors.maxcapacity.type ===
                                                'min' &&
                                                'ไม่สามารถกรอกค่าต่ำกว่า 0 ได้'}
                                            {errors.maxcapacity.type !==
                                                'min' && 'กรุณากรอกข้อมูล'}
                                            กรุณากรอกข้อมูล
                                        </Alert>
                                ...
                                <Box>
                                    ...
                                    {errors.burden && (
                                        <Alert
                                            ...
                                            className='mt-2'
                                        >
                                            {errors.burden.type === 'min' &&
                                                'ต้องไม่น้อยกว่า 2 ระวาง'}
                                            {errors.burden.type === 'max' &&
                                                `ต้องไม่เกิน 12 ระวาง`}
                                            {errors.burden.type !== 'min' &&
                                                errors.burden.type !== 'max' &&
                                                'กรุณากรอกข้อมูล'}
                                        </Alert>
...
function ShowForm() {
    ...
    const findMaxFts = carrierReducer.result.find(
        (result) => result.cr_id === +cr_id,
    )
                        ...
                        <Box>
                            ...
                            {errors.maxFTS && (
                                <Alert
                                    ...
                                    className={`${submit ? 'mt-2' : 'hidden'}`}
                                >
                                    {errors.maxFTS.type === 'min' &&
                                        'กรุณากรอกค่าที่มากกว่าหรือเท่ากับ 0'}
                                    {errors.maxFTS.type === 'max' &&
                                        `ทุ่นสามารถเข้าได้สูงสุดแค่ ${findMaxFts?.carrier_max_FTS} ทุ่น`}
                                    {errors.maxFTS.type !== 'min' &&
                                        errors.maxFTS.type !== 'max' &&
                                        'กรุณากรอกข้อมูล'}
                                </Alert>
            ...
            <>
              ...
              {errors.bulkArray &&
                ...
                <Stack
                    direction='row'
                    spacing={2}
                    className='col-span-2 flex mt-5'
                >
                    <Button
                        type='submit'
                        size='small'
