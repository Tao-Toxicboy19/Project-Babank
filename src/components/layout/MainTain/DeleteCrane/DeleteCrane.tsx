...
import { deleteMainTainCrane } from '../../../../store/slices/MainTain/CraneSlice';

type Props = {
    id: number
}

export default function DeleteCrane({ id }: Props) {
    ...
    const handleDeleteConfirm = async () => {
        ...
        try {
            await dispatch(deleteMainTainCrane(id, setOpen))
